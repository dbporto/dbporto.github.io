var JSONdashboard = {
	"overview": {
		...
		"graphs": [
			{
				"title": "Meu titulo",
				"google_id": "12535654214181780356",
				"timeframe": "1h",
				"autorefresh": "true",
				"showLegend": "true"
			},
	...
	"overviewExtra": {
		...
		"graphs": [
			{
				"title": "Meu titulo",
				"google_id": "13273750352647881124",
				"timeframe": "1h",
				"autorefresh": "true",
				"showLegend": "true"
			},
			...
			{
				"title": "Meu titulo",
				"google_id": "16977468836365572409",
				"timeframe": "1h",
				"autorefresh": "true",
				"showLegend": "true"
			},
	...
	"SQLdb": {
		...
		"graphs": [
			{
				"title": "Meu titulo",
				"google_id": "15524514366712537707",
				"timeframe": "1h",
				"autorefresh": "true",
				"showLegend": "true"
			},
			{
				"title": "Meu titulo",
				"google_id": "10981039593291568802",
				"timeframe": "1h",
				"autorefresh": "true",
				"showLegend": "true"
			},
	...
	"account": {
		"graphURL1":"https://public.google.stackdriver.com/public/chart/590314631763103316?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h",
		"graphURL2":"https://public.google.stackdriver.com/public/chart/2371923162729352133?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h",
		"graphURL3":"https://public.google.stackdriver.com/public/chart/12473177168262476028?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h",
		"graphURL4":"https://public.google.stackdriver.com/public/chart/923128817732870430?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h"
	},
	"compliance": {
		"graphURL1":"https://public.google.stackdriver.com/public/chart/590314631763103316?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h",
		"graphURL2":"https://public.google.stackdriver.com/public/chart/2371923162729352133?drawMode=color&showLegend=true&theme=light&autoRefresh=true&timeframe=1h",
...
setInterval( 
	function(){
		var el1 = document.getElementById('iframe1');
		var el2 = document.getElementById('iframe2');
		var el3 = document.getElementById('iframe3');
